...
public class OracleDefine implements SQLFactory {
    ...
    private final String sys008 = "insert into sys_theme_value(uuid,theme_id,res_id,res_url,res_type,res_bg_color,res_class,group_id,res_img,sort_id) value(sys_guid(),?,?,?,?,?,?,?,?,?)";
    private final String sys009 = "update sys_theme_value set res_url = ?, res_bg_color = ?, res_class = ?, res_img = ?, group_id = ?, sort_id = ?, res_type = ? where theme_id = ? and res_id = ?";
    ...
    private final String sys012 = "select uuid,user_id,handle_time,client_ip,status_code,method,url,data from sys_handle_logs t where t.domain_id = ? order by handle_time desc";
    ...
    private final String sys018 = "insert into sys_user_info (user_id,user_name,user_create_date,user_owner,user_email,user_phone,org_unit_id,user_maintance_date,user_maintance_user) values(?,?,sysdate,?,?,?,?,sysdate,?)";
    ...
    private final String sys026 = "insert into sys_role_info(role_id,role_name,role_owner,role_create_date,role_status_id,domain_id,role_maintance_date,role_maintance_user,code_number) values(?,?,?,sysdate,?,?,sysdate,?,?)";
    private final String sys027 = "delete from sys_role_info where role_id = ? and domain_id = ?";
    ...
    private final String sys029 = "select uuid,user_id,handle_time,client_ip,status_code,method,url,data from sys_handle_logs t where t.domain_id = ? order by handle_time desc limit ?,?";
    private final String sys030 = "select count(*) from sys_handle_logs t where t.domain_id = ?";
    private final String sys031 = "select uuid,user_id,handle_time,client_ip,status_code,method,url,data from sys_handle_logs t where t.domain_id = ? and user_id = ? and handle_time >= to_date(?,'YYYY-MM-DD') and handle_time < to_date(?,'YYYY-MM-DD') order by handle_time desc";
    private final String sys032 = "select uuid,user_id,handle_time,client_ip,status_code,method,url,data from sys_handle_logs t where t.domain_id = ? and user_id = ? and handle_time >= to_date(?,'YYYY-MM-DD') order by handle_time desc";
    private final String sys033 = "select uuid,user_id,handle_time,client_ip,status_code,method,url,data from sys_handle_logs t where t.domain_id = ? and handle_time >= to_date(?,'YYYY-MM-DD') and handle_time < to_date(?,'YYYY-MM-DD') order by handle_time desc";
    private final String sys034 = "select domain_id from sys_domain_share_info t where t.target_domain_id = ?";
    private final String sys035 = "select uuid,user_id,handle_time,client_ip,status_code,method,url,data from sys_handle_logs t where t.domain_id = ? and handle_time >= to_date(?,'YYYY-MM-DD') order by handle_time desc";
    private final String sys036 = "insert into sys_domain_info(domain_id,domain_name,domain_status_id,domain_create_date,domain_owner,domain_maintance_date,domain_maintance_user) values(?,?,?,sysdate,?,sysdate,?)";
    private final String sys037 = "delete from sys_domain_info where domain_id = ?";
    private final String sys038 = "update sys_domain_info set domain_name = ?, domain_status_id = ?, domain_maintance_date = sysdate, domain_maintance_user = ? where domain_id = ?";
    private final String sys039 = "select uuid,user_id,handle_time,client_ip,status_code,method,url,data from sys_handle_logs t where t.domain_id = ? and handle_time < to_date(?,'YYYY-MM-DD') order by handle_time desc";
    ...
    private final String sys041 = "select org_unit_id as org_id,org_unit_desc as org_desc,up_org_id,t.domain_id,create_date,maintance_date as modify_date,create_user,maintance_user as modify_user,code_number from sys_org_info t where t.domain_id = ?";
    ...
    private final String sys086 = "insert into sys_domain_share_info(uuid,domain_id,target_domain_id,authorization_level,create_user,create_date,modify_date,modify_user) values(sys_guid(),?,?,?,?,sysdate,sysdate,?)";
    ...
    private final String sys119 = "insert into dispatch_argument_define(arg_id,arg_type,arg_value,code_number,create_user,create_date,modify_user,modify_date,domain_id,arg_desc,bind_as_of_date) values(?,?,?,?,?,sysdate,?,sysdate,?,?,?)";
    private final String sys120 = "delete from dispatch_argument_define where arg_id = ? and domain_id = ?";
    private final String sys121 = "update dispatch_argument_define set modify_user = ?, modify_date = sysdate, bind_as_of_date = ?, arg_desc = ?, arg_value = ? where arg_id = ? and domain_id = ?";
    ...
    private final String sys124 = "insert into dispatch_group_define(group_id,code_number,group_desc,create_user,create_date,modify_user,modify_date,domain_id) values(?,?,?,?,sysdate,?,sysdate,?)";
    private final String sys125 = "insert into dispatch_task_define(task_id,code_number,task_desc,task_type,create_user,create_date,modify_date,modify_user,domain_id,script_file) values(?,?,?,?,?,sysdate,sysdate,?,?,?)";
    ...
    private final String sys128 = "insert into dispatch_batch_define(batch_id,code_number,batch_desc,batch_status,as_of_date,ret_msg,complete_date,domain_id) values(?,?,?,?,to_date(?,'YYYY-MM-DD'),?,to_date(?,'YYYY-MM-DD'),?)";
    private final String sys129 = "delete from dispatch_batch_define where batch_id = ? and domain_id = ?";
    private final String sys130 = "update dispatch_batch_define set batch_desc = ?, batch_status = ?,as_of_date = to_date(?,'YYYY-MM-DD'), complete_date = to_date(?,'YYYY-MM-DD') where batch_id = ? and domain_id = ?";
    ...
    private final String sys144 = "insert into dispatch_task_argument_rel(uuid,task_id,arg_id,domain_id,arg_value,sort_id) values(sys_guid(),?,?,?,?,?)";
    ...
    private final String sys149 = "insert into dispatch_group_argument_rel(uuid,id,arg_id,arg_value,domain_id) values(sys_guid(),?,?,?,?)";
    ...
    private final String sys151 = "insert into dispatch_task_dependency(uuid,id,up_id,domain_id) values(sys_guid(),?,?,?)";
    ...
    private final String sys156 = "insert into dispatch_group_dependency(uuid,id,up_id,domain_id) values(sys_guid(),?,?,?)";
    private final String sys157 = "select to_char(as_of_date,'YYYY-MM-DD') as as_of_date from dispatch_batch_define where batch_id = ?";
    private final String sys158 = "insert into dispatch_batch_argument_rel(uuid,batch_id,arg_id,arg_value,domain_id) values(sys_guid(),?,?,?,?)";
    private final String sys161 = "update dispatch_batch_define set as_of_date = to_date(?,'YYYY-MM-DD') where batch_id = ?";
    private final String sys162 = "select distinct sys_guid() as uuid,r.batch_id,d.arg_id,a.arg_value,r.domain_id,d.bind_as_of_date from dispatch_batch_group_relation r inner join dispatch_group_task_relation g on r.group_id=g.group_id inner join dispatch_task_argument_rel t on g.task_id = t.task_id inner join dispatch_argument_define d on t.arg_id = d.arg_id left join dispatch_batch_argument_rel a on a.batch_id = r.batch_id and a.arg_id = t.arg_id  where d.arg_type = '4' and r.domain_id = ?";
    ...
    private final String sys176 = "TODO";
    private final String sys177 = "select count(*) from dispatch_batch_group_status where batch_id = ? and status = '2'";
    private final String sys178 = "update dispatch_batch_define set batch_status = '1',start_date = sysdate, ret_msg = '',end_date = '' where batch_id = ? and complete_date >= as_of_date";
    private final String sys179 = "update dispatch_batch_define set ret_msg = ? , end_date = sysdate, batch_status = ? where batch_id = ?";
    ...
    private final String sys188 = "update dispatch_batch_group_status set start_time = sysdate, status = ? where gid = ? and batch_id = ?";
    private final String sys189 = "update dispatch_batch_group_status set end_time = sysdate, status = ? where gid = ? and batch_id = ?";
    private final String sys190 = "update dispatch_batch_job_status set start_time = sysdate, status = ? where batch_id = ? and job_id = ?";
    private final String sys191 = "update dispatch_batch_job_status set end_time = sysdate, status = ? where batch_id = ? and job_id = ?";
