 ...
 */
@Configuration
public class OracleDefine implements SQLFactory {
    ...
    private final String sys_rdbms_008 = "insert into sys_theme_value(uuid,theme_id,res_id,res_url,res_type,res_bg_color,res_class,group_id,res_img,sort_id) value(sys_guid(),?,?,?,?,?,?,?,?,?)";
    private final String sys_rdbms_009 = "update sys_theme_value set res_url = ?, res_bg_color = ?, res_class = ?, res_img = ?, group_id = ?, sort_id = ?, res_type = ? where theme_id = ? and res_id = ?";
    ...
    private final String sys_rdbms_018 = "insert into sys_user_info (user_id,user_name,user_create_date,user_owner,user_email,user_phone,org_unit_id,user_maintance_date,user_maintance_user) values(?,?,sysdate,?,?,?,?,sysdate,?)";
    ...
    private final String sys_rdbms_021 = "update sys_user_info t set t.user_name = ?, t.user_phone = ?, t.user_email = ? ,t.user_maintance_date = sysdate, t.user_maintance_user = ?,t.org_unit_id = ? where t.user_id = ?";
    ...
    private final String sys_rdbms_026 = "insert into sys_role_info(role_id,role_name,role_owner,role_create_date,role_status_id,domain_id,role_maintance_date,role_maintance_user,code_number) values(?,?,?,sysdate,?,?,sysdate,?,?)";
    ...
    private final String sys_rdbms_031 = "select uuid,user_id,handle_time,client_ip,status_code,method,url,data from sys_handle_logs t where t.domain_id = ? and user_id = ? and handle_time >= to_date(?,'YYYY-MM-DD') and handle_time < to_date(?,'YYYY-MM-DD') order by handle_time desc";
    private final String sys_rdbms_032 = "select uuid,user_id,handle_time,client_ip,status_code,method,url,data from sys_handle_logs t where t.domain_id = ? and user_id = ? and handle_time >= to_date(?,'YYYY-MM-DD') order by handle_time desc";
    private final String sys_rdbms_033 = "select uuid,user_id,handle_time,client_ip,status_code,method,url,data from sys_handle_logs t where t.domain_id = ? and handle_time >= to_date(?,'YYYY-MM-DD') and handle_time < to_date(?,'YYYY-MM-DD') order by handle_time desc";
    private final String sys_rdbms_034 = "select domain_id from sys_domain_share_info t where t.target_domain_id = ?";
    private final String sys_rdbms_035 = "select uuid,user_id,handle_time,client_ip,status_code,method,url,data from sys_handle_logs t where t.domain_id = ? and handle_time >= to_date(?,'YYYY-MM-DD') order by handle_time desc";
    private final String sys_rdbms_036 = "insert into sys_domain_info(domain_id,domain_name,domain_status_id,domain_create_date,domain_owner,domain_maintance_date,domain_maintance_user) values(?,?,?,sysdate,?,sysdate,?)";
    private final String sys_rdbms_037 = "delete from sys_domain_info where domain_id = ?";
    private final String sys_rdbms_038 = "update sys_domain_info set domain_name = ?, domain_status_id = ?, domain_maintance_date = sysdate, domain_maintance_user = ? where domain_id = ?";
    private final String sys_rdbms_039 = "select uuid,user_id,handle_time,client_ip,status_code,method,url,data from sys_handle_logs t where t.domain_id = ? and handle_time < to_date(?,'YYYY-MM-DD') order by handle_time desc";
    ...
    private final String sys_rdbms_043 = "insert into sys_org_info(code_number,org_unit_desc,up_org_id,domain_id,create_date,maintance_date,create_user,maintance_user,org_unit_id) values(?,?,?,?,sysdate,sysdate,?,?,?)";
    ...
    private final String sys_rdbms_048 = "insert into sys_role_user_relation(uuid,role_id,user_id,maintance_date,maintance_user) values(sys_guid(),?,?,sysdate,?)";
    private final String sys_rdbms_050 = "update sys_role_info t set t.role_name = ? ,t.role_status_id = ?, role_maintance_date = sysdate, role_maintance_user = ? where t.role_id = ?";
    private final String sys_rdbms_069 = "update sys_org_info set org_unit_desc = ? ,up_org_id = ?, maintance_date = sysdate,maintance_user=? where org_unit_id = ?";
    private final String sys_rdbms_070 = "select t.theme_id,i.theme_desc, res_id,res_url,res_type,res_bg_color,res_class,group_id,res_img,sort_id from sys_theme_value t left join sys_theme_info i on t.theme_id = i.theme_id where t.theme_id = ? and t.res_id = ?";
    ...
    private final String sys_rdbms_086 = "insert into sys_domain_share_info(uuid,domain_id,target_domain_id,authorization_level,create_user,create_date,modify_date,modify_user) values(sys_guid(),?,?,?,?,sysdate,sysdate,?)";
    private final String sys_rdbms_087 = "delete from sys_domain_share_info where uuid = ?";
    private final String sys_rdbms_088 = "update sys_domain_share_info set authorization_level = ?,modify_user = ? , modify_date = sysdate where uuid = ?";
    ...
    private final String sys_rdbms_096 = "insert into sys_role_user_relation(uuid,role_id,user_id,maintance_date,maintance_user) values(?,?,?,sysdate,?)";
    ...
    private final String sys_rdbms_101 = "select t.theme_id,i.theme_desc,res_id,res_url,res_type,res_bg_color,res_class,group_id,res_img,sort_id from sys_theme_value t inner join sys_theme_info i on t.theme_id = i.theme_id where t.theme_id = ? order by group_id,sort_id asc";
    ...
    private final String sys_rdbms_128 = "insert into dispatch_batch_define(batch_id,code_number,batch_desc,batch_status,as_of_date,ret_msg,complete_date,domain_id) values(?,?,?,?,to_date(?,'YYYY-MM-DD'),?,to_date(?,'YYYY-MM-DD'),?)";
    private final String sys_rdbms_129 = "delete from dispatch_batch_define where batch_id = ? and domain_id = ?";
    private final String sys_rdbms_130 = "update dispatch_batch_define set batch_desc = ?, batch_status = ?,as_of_date = to_date(?,'YYYY-MM-DD'), complete_date = to_date(?,'YYYY-MM-DD') where batch_id = ? and domain_id = ?";
    ...
    private final String sys_rdbms_176 = "TODO";
    ...
    private final String sys_rdbms_207 = "insert into sys_handle_logs(uuid,user_id,handle_time,client_ip,status_code,method,url,data,domain_id) values(sys_guid(),?,sysdate,?,?,?,?,?,?)";
    ...
    public String getSqlText(String id) throws NoSuchFieldException, IllegalAccessException {
        Field field = OracleDefine.class.getDeclaredField(id);
