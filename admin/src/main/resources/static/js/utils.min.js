            ...
            preprocess:function () {
                $.getJSON("/v1/auth/user/query",function (data) {
                    $(data).each(function (index, element) {
                        ...
                        $("#h-user-details-user-create").html(element.user_owner)
                        $("#h-user-details-user-create-date").html(element.user_create_date)
                        $("#h-user-details-user-modify").html(element.user_maintance_user)
                        $("#h-user-details-user-modify-date").html(element.user_maintance_date)
                        // 机构编码处理
