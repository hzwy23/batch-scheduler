...
public class MySQLBatchSqlDefine implements SQLFactory {
    ...
    private final String sys_rdbms_144 = "insert into dispatch_task_argument_rel(uuid,task_id,arg_id,domain_id,arg_value,sort_id) values(replace(uuid(),'-',''),?,?,?,?,?)";
    ...
    private final String sys_rdbms_149 = "insert into dispatch_group_argument_rel(uuid,job_key,arg_id,arg_value,domain_id) values(replace(uuid(),'-',''),?,?,?,?)";
    ...
    private final String sys_rdbms_156 = "insert into dispatch_group_dependency(uuid,suite_key,up_suite_key,domain_id) values(replace(uuid(),'-',''),?,?,?)";
    ...
    private final String sys_rdbms_158 = "insert into dispatch_batch_argument_rel(uuid,batch_id,arg_id,arg_value,domain_id) values(replace(uuid(),'-',''),?,?,?,?)";
    ...
    private final String sys_rdbms_164 = "select distinct replace(uuid(),'-','') as uuid,r.batch_id,d.arg_id,a.arg_value,r.domain_id,d.bind_as_of_date from dispatch_batch_group_relation r inner join dispatch_group_task_relation g on r.group_id=g.group_id inner join dispatch_task_argument_rel t on g.task_id = t.task_id inner join dispatch_argument_define d on t.arg_id = d.arg_id left join dispatch_batch_argument_rel a on a.batch_id = r.batch_id and a.arg_id = t.arg_id where d.arg_type = '4' and r.domain_id = ? and r.batch_id = ?";
